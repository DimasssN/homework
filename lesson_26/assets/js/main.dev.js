...
function info() {
  for (var key in car) {
    document.getElementById('res').innerHTML += "<p><span style=\"font-weight: bold; text-transform: capitalize;\">".concat(key, ":</span> ").concat(car[key], "</p>");
  }
}
